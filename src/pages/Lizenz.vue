    ...
    <q-card  class="shadow-8" style='margin-bottom:25px'>
      <q-card  class="shadow-8" style='margin-bottom:25px;'>
        <q-card-section class='bg-primary text-white text-h3'>
          Nutzungslizenz: Apache License
        </q-card-section>
        <q-card-section>

<p>Version 2.0, Januar 2004<br>
<br>
...
<p>Zur Anwendung der Apache-Lizenz auf Ihr Werk hängen Sie ihm den folgenden Standardhinweis an, wobei Sie die von eckigen Klammern „[]“ eingeschlossenen Felder durch Ihre eigenen Angaben ersetzen. (Die eckigen Klammern dabei weglassen!) Der Text muss von der entsprechenden Kommentarsyntax für das Dateiformat umschlossen sein. Wir empfehlen außerdem, einen Datei- oder Klassennamen und eine Beschreibung des Zwecks auf derselben Druckseite wie der Urheberrechtshinweis anzugeben, damit das Auffinden in den Archiven Dritter erleichtert wird.</p>

<p>Copyright 2020 STROMDAO GmbH</p>

<p>Lizenziert gemäß Apache Licence Version 2.0 (die „Lizenz“); Nutzung dieser Datei nur in Übereinstimmung mit der Lizenz erlaubt. Eine Kopie der Lizenz erhalten Sie auf http://www.apache.org/licenses/LICENSE-2.0.</p>
